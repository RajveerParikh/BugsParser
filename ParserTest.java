...
public class ParserTest {
    ...
    public void testIsSwitchStatement(){
    	...
    	use("switch { \n case xyz+3 \n turn xyz+3 \n } \n");
    	assertTrue(parser.isSwitchStatement());
    	assertStackTopEquals(createNode(tree("switch", tree("case", tree("+", "xyz", "3.0"), tree("turn", tree("+", "xyz", "3.0"))))));
    	use("switch { \n case xyz+3 \n turn xyz+3 \n case abc+2 \n turnto abc+2 \n } \n");
    	assertTrue(parser.isSwitchStatement());
    	assertStackTopEquals(createNode(tree("switch", tree("case", tree("+", "xyz", "3.0"), tree("turn", tree("+", "xyz", "3.0"))),tree("case", tree("+", "abc", "2.0"), tree("turnto", tree("+", "abc", "2.0"))) )));
    }
    ...
    public void testIsDoStatement(){
    	...
    	assertStackTopEquals(createNode(tree("do", "abc", tree("var", tree("+", "a", "b"), tree("+", "c", "d")))));
    	use("do abc (a+b , c+d, e+f) \n");
    	assertTrue(parser.isDoStatement());
    	assertStackTopEquals(createNode(tree("do", "abc", tree("var", tree("+", "a", "b"), tree("+", "c", "d"), tree("+", "e", "f")))));	
    }
    ...
    public void testIsProgram(){
    	...
    	use("Bug abc { \n move a+b \n} \n");
    	assertTrue(parser.isProgram());
    	assertStackTopEquals(createNode(tree("program", "Allbugs", tree("list", tree("Bug", "abc", "list", "initially", tree("block", tree("move", tree("+", "a", "b"))), "list")))));
    }
